...
class mirrorclamp : public sb7::application
{
public:
    mirrorclamp();
    void init();
...
void mirrorclamp::render(double T)
{
...
void mirrorclamp::onKey(int key, int action)
{
    if (action)
    {
        switch (key)
